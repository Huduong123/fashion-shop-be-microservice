...
import io.github.Huduong123.product_service.dto.admin.product.ProductVariantCreateDTO;
...
import io.github.Huduong123.product_service.dto.admin.product.ProductVariantUpdateDTO;
import io.github.Huduong123.product_service.dto.common.ResponseMessageDTO;
import io.github.Huduong123.product_service.entity.BaseEntity;
import io.github.Huduong123.product_service.entity.Category;
import io.github.Huduong123.product_service.entity.Color;
import io.github.Huduong123.product_service.entity.Product;
...
import io.github.Huduong123.product_service.mapper.ProductMapper;
import io.github.Huduong123.product_service.mapper.ProductVariantMapper;
import io.github.Huduong123.product_service.mapper.ProductVariantSizeMapper;
...
import io.github.Huduong123.product_service.repository.ProductRepository;
import io.github.Huduong123.product_service.repository.SizeRepository;
import io.github.Huduong123.product_service.specification.ProductSpecification;
    ...
    private void updateProductVariantImages(ProductVariant variant, List<ProductVariantImageDTO> imageDTOs) {
        ...
        if (!variant.getImages().isEmpty()) {
            ...
            if (!newPrimaryExists) {
                ...
                if (currentPrimaryImageId != null) {
                    ...
                    if (dtoMap.containsKey(currentPrimaryImageId)) {
                        ...
                        variant.getImages().stream()
                                .filter(img -> img.getImageUrl()
                                        .equals(dtoMap.get(currentPrimaryImageId).getImageUrl()))
                                .findFirst()
                                .ifPresent(img -> {
                                    img.setPrimary(true);
                                });
                ...
                // Nếu không thể khôi phục (ảnh chính cũ đã bị xóa), thì mới đặt ảnh đầu tiên
                // làm ảnh chính
                if (!restored) {
